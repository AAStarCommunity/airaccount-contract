/**
 * test-m7-e2e.ts — M7 E2E Tests: Factory clone pattern + guard externalization (Sepolia)
 *
 ...
 *
 * Prerequisites:
 *   - pnpm tsx scripts/deploy-m7.ts (set AIRACCOUNT_M7_FACTORY in .env.sepolia)
...
const FACTORY_ADDR   = (process.env.AIRACCOUNT_M7_FACTORY ?? required("AIRACCOUNT_M7_FACTORY")) as Address;
...
async function main() {
  console.log("=== M7 E2E Tests: Clone Factory + Guard Externalization (Sepolia) ===\n");
  ...
  console.log("\n═══════════════════════════════════════");
  console.log(`M7 E2E Results: ${testsPassed} pass, ${testsFailed} fail`);
