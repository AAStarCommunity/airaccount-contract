...
const FACTORY_ADDR = (process.env.AIRACCOUNT_V019_FACTORY ?? process.env.AIRACCOUNT_V018_FACTORY ?? process.env.FACTORY_ADDRESS ?? process.env.AIRACCOUNT_M5_FACTORY ?? "0x24cd3231a8dd261da8cb1e6b017d1d1c4077c078") as Address;
const BLS_ALGORITHM_ADDR = (process.env.AIRACCOUNT_V019_BLS_ALGORITHM ?? process.env.AIRACCOUNT_V018_BLS_ALGORITHM ?? process.env.BLS_ALGORITHM_ADDRESS ?? "0xc2096E8D04beb3C337bb388F5352710d62De0287") as Address;
const VALIDATOR_ROUTER_ADDR = (process.env.AIRACCOUNT_V019_VALIDATOR_ROUTER ?? process.env.AIRACCOUNT_V018_VALIDATOR_ROUTER ?? process.env.VALIDATOR_ROUTER_ADDRESS ?? "0x730a162Ce3202b94cC5B74181B75b11eBB3045B1") as Address;
