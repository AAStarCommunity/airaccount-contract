/**
 * deploy-m7-r4.ts — Deploy AirAccount M7 r4 (full module stack) to Sepolia
 *
...
const SALT = 740n; // M7 r4 account salt
...
async function main() {
  ...
  console.log("=== Deploy AirAccount M7 r4 (full module stack) to Sepolia ===\n");
  ...
  console.log("\n[4/6] Deploy AAStarAirAccountFactoryV7 (M7 r4)...");
  ...
  // ─── Summary ─────────────────────────────────────────────────────────────
  console.log("\n═══════════════════════════════════════════════════════════════");
  console.log(" M7 r4 Deployment Complete");
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("\nAdd to .env.sepolia:");
  console.log(`AIRACCOUNT_M7_R4_FACTORY=${factoryAddr}`);
  console.log(`AIRACCOUNT_M7_R4_IMPL=${implAddr}`);
  console.log(`AIRACCOUNT_M7_R4_ACCOUNT=${predictedAddr}`);
  console.log(`AIRACCOUNT_M7_R4_COMPOSITE_VALIDATOR=${compositeValidatorAddr}`);
  console.log(`AIRACCOUNT_M7_R4_TIER_GUARD_HOOK=${tierGuardHookAddr}`);
  console.log(`AIRACCOUNT_M7_R4_AGENT_SESSION_VALIDATOR=${agentSessionValidatorAddr}`);
