/**
 * deploy-m7-r9.ts — Deploy AirAccount M7 r9 (security fixes) to Sepolia
 *
 * Changes from r8:
 ...
 *   4. AAStarAirAccountFactoryV7 (r9 implementation — MEDIUM-1/MEDIUM-2 fix)
 *   5. Test account via factory (salt=1001)
 *   6. Funds account with 0.05 ETH + 0.02 ETH EntryPoint deposit
 *
 * Usage:
 *   pnpm tsx scripts/deploy-m7-r9.ts
 *
...
const SALT = 1001n; // r9 — fresh account for E2E (r8 used 1000)
...
async function main() {
  ...
  console.log("=== Deploy AirAccount M7 r9 (security fixes) to Sepolia ===\n");
  ...
  // ─── 3. AgentSessionKeyValidator (HIGH-1 fix) ────────────────────────────
  console.log("\n[3/6] Deploy AgentSessionKeyValidator (r9: 66-byte sig required)...");
  ...
  console.log("\n[4/6] Deploy AAStarAirAccountFactoryV7 (r9)...");
  ...
  // ─── Summary ─────────────────────────────────────────────────────────────
  console.log("\n═══════════════════════════════════════════════════════════════");
  console.log(" M7 r9 Deployment Complete");
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("\nAdd to .env.sepolia:");
