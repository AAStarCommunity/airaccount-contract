...
contract AAStarGlobalGuardTest is Test {
    ...
    function setUp() public {
        ...
        algIds[0] = ALG_ECDSA;
        guard = new AAStarGlobalGuard(account, DAILY_LIMIT, algIds);
    }
    ...
    function test_constructor_multipleAlgorithms() public {
        ...
        algIds[1] = ALG_BLS;
        algIds[2] = ALG_P256;
        AAStarGlobalGuard g = new AAStarGlobalGuard(account, DAILY_LIMIT, algIds);
    ...
    function test_unlimitedWhenDailyLimitIsZero() public {
        uint8[] memory algIds = new uint8[](1);
        algIds[0] = ALG_ECDSA;
        AAStarGlobalGuard unlimitedGuard = new AAStarGlobalGuard(account, 0, algIds);
