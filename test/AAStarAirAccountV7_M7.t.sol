...
contract MockRegistry {
    ...
    // Accepts 2-arg registerAgent(address,bytes) matching the updated AgentRegistry interface.
    function registerAgent(address agentWallet, bytes calldata) external {
