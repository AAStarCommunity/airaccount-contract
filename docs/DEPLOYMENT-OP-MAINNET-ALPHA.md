...
**对档位的意义**：真正该参照的是**将来实际接线的那个代币上的成员余额**。3.5.0 供应量为 0、尚未发放，
所以只能看先例——生态现役 3.4.0 上 Jason 持有 **15,539**，正落在上表第一行，
即 tier1 = 钱包的 10%、tier2 覆盖整个钱包。**$30 锚点在这个先例下是站得住的。**
本仓那个 2,780 来自一个已过期的代币，不应作为定档依据。
