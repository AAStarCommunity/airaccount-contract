...
**版本**: v0.16.0（M7 r4，全审计修复版）
**更新日期**: 2026-03-22
**网络**: Sepolia 测试网（Chain ID: 11155111）
**测试数**: 660 单元测试全部通过 ✅（含 codeex 审计 4 项修复验证）
...
| 合约 | 地址 | 说明 |
|------|------|------|
| **M7 r4 Factory（最新）** | `0x61bbaf9e1b8fd78ff874776cfa50497db9d43c3f` | EIP-1167 clone 工厂，r4 全审计修复版 |
| **M7 r4 Implementation** | `0xA674D308ce22230B70412b20Ee5a66fC6B24F49c` | 共享实现（23,847B，EIP-170 合规） |
| **M7 r4 Account（salt=740）** | `0x9Ed9e94d65D00Aa646Fb7671ED70e9C8E0d82082` | 2-of-3 guardians，E2E 验证 ✅ |
| **AirAccountCompositeValidator** | `0xb65569950c48aa56dbe876915ca3605fd6ff2980` | 工厂默认 Validator 模块 |
| **TierGuardHook** | `0x67f878295cff7451cbd2a775c4490607af1b07d7` | 工厂默认 Hook 模块，ALG_WEIGHTED 修复 |
| **AgentSessionKeyValidator** | `0x1f06961e133217801f92e1cf552187f594a32873` | AI 代理 Validator，selectorAllowlist 修复 |
| EntryPoint v0.7 | `0x0000000071727De22E5E9d8BAf0edAc6f37da032` | ERC-4337 单例（官方） |

#### M7 r1（保留，历史参考）
| 合约 | 地址 | 说明 |
|------|------|------|
| M7 Factory (r1) | `0x9D0735E3096C02eC63356F21d6ef79586280289f` | 初版 M7 |
| M7 Implementation (r1) | `0xf01e3Dd359DfF8e578Ee8760266E3fB9530F07A0` | 24,497B |
| M7 Account (salt=2000, r1) | `0xb185C9634dCBC43F71bE7de15001A438eDC50DEb` | |
...
| 类型 | 数量 | 状态 |
|------|:----:|:----:|
| Foundry 单元测试 | **660** | ✅ 全部通过（含 6 项审计修复专项测试） |
| Sepolia E2E 测试 | **约 80+** | ✅ 全部通过（M1–M7，含 M7 r4 第二次运行） |
| 内部安全审计 | 4 轮 | ✅（docs/2026-03-22-m7-audit-report-v4.md） |
...
*文档版本：v1.1.0（2026-03-22）— 更新 M7 r4 合约地址、测试数（660）、第四轮审计修复记录*
